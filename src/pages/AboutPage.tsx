  ...
  return (
    <div className="flex flex-col gap-8 pb-10 pt-6">
      ...
      <motion.div 
        ...
        className="bg-white dark:bg-slate-900 rounded-[32px] p-6 md:p-10 border border-slate-200 dark:border-slate-800 shadow-sm mt-2 flex flex-col gap-6"
      >
        {/* Logo Image */}
          ...
          {ABOUT_FEATURES.map((feature, idx) => {
            ...
            return (
              <motion.div
                ...
                className="bg-gradient-to-br from-blue-500 to-blue-700 dark:from-blue-600 dark:to-blue-900 rounded-3xl p-6 border-t border-white/30 shadow-sm text-center text-white relative overflow-hidden group"
              >
                ...
                <div className="relative z-10 w-14 h-14 rounded-2xl bg-white/20  border border-white/30 flex items-center justify-center text-white mx-auto mb-4 shadow-sm">
                  <Icon size={26} strokeWidth={2.5} />
                </div>
                <h3 className="relative z-10 font-bold text-white text-lg mb-2 ">{feature.title}</h3>
