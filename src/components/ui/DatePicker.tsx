    ...
    <div className="relative" ref={ref}>
      <button
        ...
        className={cn(
          ...
          value
            ? "bg-white dark:bg-slate-800 border-2 border-blue-500 text-blue-700 dark:text-blue-300 shadow-[0_4px_15px_rgba(59,130,246,0.25)]"
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="absolute right-0 top-full mt-3 w-[300px] bg-white/95 dark:bg-slate-900/95 backdrop-blur-xl rounded-[24px] shadow-[0_12px_40px_rgba(0,0,0,0.12)] border border-white/50 dark:border-slate-700/50 p-5 z-50 origin-top-right overflow-hidden"
          >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected 
                        ? "text-white shadow-[0_8px_16px_-4px_rgba(59,130,246,0.4)]" 
                        : isCurrentMonth 
